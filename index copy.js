...
// // let usbserial = '/dev/ttyUSB1';
// let usbserial = '/dev/ttyACM0'
...
//     const prediction = await predict(pose)
//     if (prediction !== 'M') {
...
// let Actions, Actions_adversaire, Balle, Balle_adverse, Etat, Etat_adverse, act_adv, nbr_b, nbr_b_adv
...
//   for (let i = 0, _pj_a = p.length; i < _pj_a; i += 1) {
//     p.pop()
//   }
// }
